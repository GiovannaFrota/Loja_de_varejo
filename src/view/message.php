...
<body>
    <main class="flex justify-center items-center w-full h-screen">
        ...
        ?>
            <article class="w-2/4 bg-red-700 text-white flex flex-column items-center">
                <p class="p-4" \>
        ...
        ?>
        <?php
        if (!empty($SESSION['msg_warning'])) :
        ?>
            <article class="w-2/4 bg-orange-700 text-white flex justify-center">
                <ul class="p-4">
